...
gFile="audio_pikeralphaALC-120.sh"
...
sh /tmp/AppleHDA8Series.sh -a $gCodec -l $gAudioid -t $gLibraryDirectory
...
1|2 )
    ...
    sudo rm "$gDesktopDirectory$gCodec-${gDebugMode[$gDebug]}"/Info-*.plist
